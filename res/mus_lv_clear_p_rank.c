...
static const unsigned char* const order2[] = {P1,P2,P3};
static const unsigned char* const order3[] = {P4,P5,P3};
static const unsigned char* const order4[] = {P7,P8,P9};
...
BANKREF(MUS_LV_CLEAR_P_RANK)
const hUGESong_t MUS_LV_CLEAR_P_RANK = {3, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
